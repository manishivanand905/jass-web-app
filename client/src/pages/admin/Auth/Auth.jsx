  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        showToast.success(isRegister ? 'Admin registered successfully' : 'Admin access granted');
  ...
  return (
    <Container>
      ...
      <Card>
        ...
        <Title>ADMIN</Title>
        <Subtitle>{isRegister ? 'REGISTRATION' : 'ACCESS PORTAL'}</Subtitle>
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <InputGroup>
              ...
              <InputWrapper>
                ...
                <Input
                  ...
                  {...register('name', FORM_RULES.required)}
                />
              </InputWrapper>
          ...
          <InputGroup>
            ...
            {!isRegister && <HelpText>Contact your system administrator to reset credentials</HelpText>}
          </InputGroup>
          ...
          <HelpText style={{ textAlign: 'center', marginTop: '1rem', cursor: 'pointer' }} onClick={toggleMode}>
            {isRegister ? 'Already have admin access? Login' : 'Need to create admin? Register'}
          </HelpText>
        </Form>
